package com.protools.flowablePOC.services.FamillePOCService;
...
public class sendGlobalErrorMessage implements JavaDelegate {
    private Logger logger =LogManager.getLogger(com.protools.flowablePOC.services.FamillePOCService.sendGlobalErrorMessage.class);
    @Override
